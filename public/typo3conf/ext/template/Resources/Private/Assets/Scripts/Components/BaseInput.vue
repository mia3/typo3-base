    ...
    export default {
        ...
        render(createElement, context) {
            ...
            const formInput = createElement(element, {
                class: props.baseClass + '__input ' + 'field--' + type,
                attrs: {
                    ...attrs,
                    type: type
                },
            ...
            content.push(createElement('div', {class: 'formFieldControl'}, field));
            if (invalid()) {
                content.push(createElement('div', {class: props.baseClass + '__validation'}, props.validation))
            }
